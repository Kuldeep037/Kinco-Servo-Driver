...
arm_interfaces__msg__MotorCmd__create()
{
  ...
  arm_interfaces__msg__MotorCmd * msg = (arm_interfaces__msg__MotorCmd *)allocator.allocate(sizeof(arm_interfaces__msg__MotorCmd), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arm_interfaces__msg__MotorCmd));
  bool success = arm_interfaces__msg__MotorCmd__init(msg);
  if (!success) {
...
arm_interfaces__msg__MotorCmd__destroy(arm_interfaces__msg__MotorCmd * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    arm_interfaces__msg__MotorCmd__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
arm_interfaces__msg__MotorCmd__Sequence__init(arm_interfaces__msg__MotorCmd__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_interfaces__msg__MotorCmd * data = NULL;

  if (size) {
    data = (arm_interfaces__msg__MotorCmd *)allocator.zero_allocate(size, sizeof(arm_interfaces__msg__MotorCmd), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arm_interfaces__msg__MotorCmd__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        arm_interfaces__msg__MotorCmd__fini(&data[i - 1]);
      }
...
arm_interfaces__msg__MotorCmd__Sequence__fini(arm_interfaces__msg__MotorCmd__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      arm_interfaces__msg__MotorCmd__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_interfaces__msg__MotorCmd__Sequence * array = (arm_interfaces__msg__MotorCmd__Sequence *)allocator.allocate(sizeof(arm_interfaces__msg__MotorCmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arm_interfaces__msg__MotorCmd__Sequence__init(array, size);
  if (!success) {
...
arm_interfaces__msg__MotorCmd__Sequence__destroy(arm_interfaces__msg__MotorCmd__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arm_interfaces__msg__MotorCmd__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arm_interfaces__msg__MotorCmd__Sequence__are_equal(const arm_interfaces__msg__MotorCmd__Sequence * lhs, const arm_interfaces__msg__MotorCmd__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arm_interfaces__msg__MotorCmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arm_interfaces__msg__MotorCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arm_interfaces__msg__MotorCmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arm_interfaces__msg__MotorCmd * data =
      (arm_interfaces__msg__MotorCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arm_interfaces__msg__MotorCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arm_interfaces__msg__MotorCmd__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!arm_interfaces__msg__MotorCmd__copy(

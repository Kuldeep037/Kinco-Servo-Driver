...
#include "arm_interfaces/msg/detail/sensor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_interfaces::msg::SensorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_interfaces::msg::SensorData & ros_message)
{
  // Member: current
  cdr >> ros_message.current;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interfaces::msg::SensorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interfaces::msg::SensorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interfaces::msg::SensorData *>(
    untyped_ros_message);
...
{
  return &arm_interfaces::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interfaces, msg, SensorData)() {
  return &arm_interfaces::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
